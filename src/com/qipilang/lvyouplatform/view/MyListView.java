package com.qipilang.lvyouplatform.view;
...
public class MyListView extends ListView implements OnScrollListener {
	...
	/**********************************************************************************
	 * DESCRIPTION:						初始化view，将加载条添加到listview底部
	 * 
	 * @param context
	 *********************************************************************************/
	...
	/**********************************************************************************
	 * DESCRIPTION:						change the view state by the state code
	 * @since							2016.3.8
	 *********************************************************************************/
	...
	/**********************************************************************************
	 * DESCRIPTION:						load complete and hide footer view
	 * @since							2016.3.8
	 *********************************************************************************/
	 ...
	 * @param iLoadListener				load data interface
	 * @param iRefalshListener			refresh data interface
	 * @since							2016.3.8
	 *********************************************************************************/
	...
	public void onScrollStateChanged(AbsListView view, int scrollState) {
		...
		/*
		 * 当屏幕停止滚动的时候scrollState的值为0
		 * 当用户手触碰屏幕的时候scrollState的值为1
	...
	/**********************************************************************************
	 * DESCRIPTION:						callback interface, load more data from 
	 * 									server
	 * @author 							Albery(张建国)
	 **********************************************************************************/
	...
	/**********************************************************************************
	 * DESCRIPTION:						callback interface, refresh data
	 * @author 							Albery(张建国)
	 **********************************************************************************/
